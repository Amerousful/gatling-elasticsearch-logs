# Gatling Elasticsearch Logs [![Sonatype Central](https://maven-badges.sml.io/sonatype-central/io.github.amerousful/gatling-elasticsearch-logs/badge.svg?style=flat)](https://central.sonatype.com/artifact/io.github.amerousful/gatling-elasticsearch-logs/)
...
```scala
libraryDependencies += "io.github.amerousful" % "gatling-elasticsearch-logs" % "1.6.4"
```
